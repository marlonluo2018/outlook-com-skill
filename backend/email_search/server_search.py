...
def server_side_search(
    ...
    try:
        ...
        if search_type == "subject":
            ...
            # Search both display name AND email address for sender
            # Note: In Outlook/Exchange, fromname often contains both name and email
            # We also try senderemail and fromemail for better coverage
