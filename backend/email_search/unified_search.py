...
# Caching removed - working directly with Outlook
...
def unified_search(
    ...
    # Validate days parameter using configured maximum
    if days < 1:
        error_msg = "Days must be at least 1"
    ...
    try:
        ...
        with OutlookSessionManager() as session:
            ...
            # Return email list directly (no cache needed)
            logger.info(f"Search completed, returning {len(email_list)} results")
